    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="ticket.php"><i class="fas fa-ticket-alt"></i> <span class="nav-text">Tickets</span></a></li>
                <li><a href="discover.php"><i class="fas fa-compass"></i> <span class="nav-text">Discover</span></a></li>
                <li><a href="billing.php"><i class="fas fa-wallet"></i> <span class="nav-text">Billing</span></a></li>
            </ul>
        </nav>
